...
import { Product, CartItem, Order, ViewLog, RestockRequest, HomeLayoutConfig, FooterPage } from './types';
import { 
  APP_STORAGE_KEY, 
...
const App: React.FC = () => {
  ...
  // Fix: Added footerPages state to satisfy Home and Admin component requirements
  ...
  const [layoutConfig, setLayoutConfig] = useState<HomeLayoutConfig>(() => {
    ...
    // Default config matching App.tsx logic
  ...
  // Fix: Added effect to persist footerPages
  useEffect(() => {
    ...
    <Router>
      <div className="min-h-screen bg-stone-50 flex flex-col selection:bg-[#C5A059] selection:text-white">
        ...
        <main className="flex-grow w-full">
          <Routes>
            {/* Fix: Added footerPages prop to satisfy HomeProps */}
            ...
            <Route 
              ...
              element={
                <Admin 
                  ...
                  // Fix: Added footerPages and setFooterPages props to satisfy AdminProps
